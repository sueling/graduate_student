...
<!-- /. NAV SIDE -->
        <div id="page-wrapper" >
            ...
            <li>論文計畫書/</li>
            <li><a href="b_s_optioncycle.jsp">師生審查意見往返</a> <span class="divider"></span></li>
            </ul>
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <p><font　face="標楷體"　color="#cc33ff"　size="7">   &nbsp;&nbsp;老師意見 : </font></p>
                    
                    <pre>
<b></b>
                    </pre>
                    <div style="position:absolute"><div class="table-responsive">
