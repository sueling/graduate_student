<%-- 
    Document   : 7-5
    Created on : 2015/9/7, 下午 03:06:40
    Author     : Ginny
--%>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#s">研究生學程計畫</a> 
            </div>
...
<!-- /. NAV SIDE -->
        <div id="page-wrapper" >
            ...
            <li><a href="d_newest.jsp">最新消息</a> <span class="divider"></span></li>
            </ul>
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
...
<form method="post" action="savenote1.jsp"> 
    ...
    <b>發言內容</b><br>
    <textarea name="suggestion" cols="60" rows="6" ></textarea><br>
