        ...
        <div id="page-wrapper" >
           ...
           <thead>
            ...
            <tr>
             ...
             <td><b><%=oral_time%></b></td>
             <td><b><form method="post" action="firstoralaccept.jsp?name=<%=st_id%>">
                    <input type=radio value="1" name="accept"> 接受
                    <input type=radio value="2" name="accept"> 不接受
