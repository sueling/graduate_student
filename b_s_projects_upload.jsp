<%-- 
    Document   : b_s_projects_upload
    Created on : 2015/9/23, 上午 09:22:08
    Author     : jill
--%>
...
<!-- /. NAV SIDE -->
        <div id="page-wrapper" >
            ...
            <li>論文計畫書/</li>
            <li><a href="b_s_projects_upload.jsp">上傳論文計畫書</a> <span class="divider"></span></li>
            </ul>
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>上傳論文計畫書(Step 2 上傳) </h2>  
                    </div>
                </div>
