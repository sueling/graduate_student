<%-- 
    Document   : b_t_optioncycle2
    Created on : 2015/10/30, 上午 07:50:11
    Author     : jill
--%>
...
<body>
    ...
    <%
            ...
            int fun=0;
            String sql3 = "SELECT distribute.st_id,distribute.te_id,distribute.id FROM distribute WHERE distribute.te_id = '"+id+"' AND distribute.over = '"+fun+"'";
            PreparedStatement smt3 = con.prepareStatement(sql3);
           ResultSet rs3 = smt3.executeQuery();
           rs3.next();
            String sql = "SELECT pro_name_chinese,pro_name_english,proposal.st_id FROM proposal RIGHT JOIN distribute ON proposal.st_id = distribute.st_id WHERE distribute.te_id = '"+id+"' AND distribute.over = '"+fun+"'";
...
<!-- /. NAV SIDE -->
        <div id="page-wrapper" >
            ...
            <li>論文計畫書/</li>
            <li><a href="b_s_optioncycle2.jsp">審查意見</a> <span class="divider"></span></li>
            </ul>
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
           ...
           <thead>
             <tr>
               ...
               <%
                ...
                <tbody>
            <tr>
                <td><b><a href="b_t_optioncycle1.jsp?name=<%=rs3.getString(1)%>"><%=pro_name_chinese%> <%=pro_name_english%></a></b></td>
            </tr>
           </tbody>
            <%
                    }
