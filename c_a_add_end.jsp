...
<jsp:useBean id="end" class="bean.condb" scope="page"></jsp:useBean>
<!DOCTYPE html>
...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.html" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV SIDE  -->
        <%
            Connection con = end.connectdb();
            String sql1 = "select * from add_point inner join student inner join proposal on add_point.st_id=student.st_id and proposal.st_id=student.st_id";
            ResultSet rs = end.executeQuery(sql1);
        %> 
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><%=rs.getString("capacity") %><%=rs.getString("payment") %></td>
                                            <td><%=rs.getString("st_name") %></td>
                                            <td><%=rs.getString("pro_name_chinese") %></td>
            ...
            <div class="form-action text-right">     
                <a href="d_a_index.jsp" class="btn btn-primary">回首頁</a>
            </div>           
         <!-- /. PAGE WRAPPER  -->
     <!-- /. WRAPPER  -->
