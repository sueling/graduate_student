<%-- 
    Document   : oral2
    Created on : 2014/12/31, 上午 09:08:25
    Author     : lin
--%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        ...
                                        <tr>
                                            <th>
                                                1.含申請論文考試當學期之已修學分數，共<input type="text" name="" size="1">學分(credit)<br>
                                                2.在學共___年，(含申請論文考試之當學期)<br>
                                                3.論文計畫書審查通過(研<input type="text" name="" size="1">上/下學期)(state)<br>
                                                4.已完成論文初稿<br>
                                                5.已備妥隨附學位考試申請書所需之論文提要一份<br> 
                                            </th>
                                            <th></th>
                                        </tr>
                                    </thead>
                            ...
                            研究生聲明：
                                    本人若於論文考試當學期之應修課程經授課教師評定為不及格，或未修畢本(系)所規定
                                    之應修總學分數，則本人論文考試停止實施；若已實施論文考試，則論文考試結果無效。
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
                 ...
                 <div class="form-action text-right">     
                    <a href="c_s_oral1.jsp" class="btn btn-primary">上一步</a>
                    <a href="c_s_oral4.jsp" class="btn btn-primary">下一步</a>
                 </div>    
                <!-- /. ROW  -->
        </div>
